  ...
  <div class="card-header">
	...
	<div class="card-block">
		@if($errors->has())
                ...
                {!! Form::model($user,['route' => ['user.updateprofile', $user->id], 'method' => 'PATCH', 'role' => 'form']) !!}
                {!! Form::hidden('reg', '0') !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                         <label class="checkbox-inline c-input c-radio">
                            {!! Form::radio('gender', '0',null,['onclick' => 'javascript: return false;']) !!} 男性 
                            <span class="c-indicator"></span>
                         </label>   
                         <label class="checkbox-inline c-input c-radio">   
                            {!! Form::radio('gender', '1',null,['onclick' => 'javascript: return false;']) !!} 女性
                            <span class="c-indicator"></span>
                         </label>   
                    </div>
                </div>
